...
class TradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post trades_url, params: { trade: { name: @trade.name, trade_duration: @trade.trade_duration } }
    end
  ...
  test "should update trade" do
    patch trade_url(@trade), params: { trade: { name: @trade.name, trade_duration: @trade.trade_duration } }
