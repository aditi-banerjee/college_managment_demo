...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { address: @faculty.address, date_of_birth: @faculty.date_of_birth, date_of_join: @faculty.date_of_join, first_name: @faculty.first_name, last_name: @faculty.last_name, salary: @faculty.salary, trade: @faculty.trade } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { address: @faculty.address, date_of_birth: @faculty.date_of_birth, date_of_join: @faculty.date_of_join, first_name: @faculty.first_name, last_name: @faculty.last_name, salary: @faculty.salary, trade: @faculty.trade } }
